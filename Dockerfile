...
# MinIO SDK for file uploads (minio-file-upload skill)
RUN uv pip install --no-cache-dir minio
# Langfuse SDK for observability (observability/langfuse plugin)
RUN uv pip install --no-cache-dir "langfuse==4.14.1"
